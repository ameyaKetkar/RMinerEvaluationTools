...
/**
 * new File("..\path\abc.txt") 中的三个方法获�?�路径的方法
 * 1： getPath() 获�?�相对路径，例如   ..\path\abc.txt
 * 2： getAbslutlyPath() 获�?��?对路径，但�?�能包�?� ".." 或 "." 字符，例如  D:\otherPath\..\path\abc.txt
 * 3： getCanonicalPath() 获�?��?对路径，但�?包�?� ".." 或 "." 字符，例如  D:\path\abc.txt
 */
