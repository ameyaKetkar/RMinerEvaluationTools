...
public class I18N {
	...
	/**
	 * 将�?��?�改这里就�?�以了: resourceBundleKey的生�?规则
	 */
	private static String getresourceBundleKey(Locale locale) {
		// return baseName + "_" + locale.toString();	// "_" 貌似与无关, 为了�??�?�性能, 故去掉
	...
	// �?�惜的是使用Local�?�以被 new 出�?�, 造�?了无法判断相等，�?��?�测试，�?�以使用 equals方法�?�判断是�?�相等
	public static void main(String[] args) {
		...
		// 下�?�的 taiwan.getLanguage()值�?为 zh,所以�?�以确定i18n实现有缺陷,�?� language�?能唯一确定Local对象
		// 造�?了无法通过 language�?好还原
