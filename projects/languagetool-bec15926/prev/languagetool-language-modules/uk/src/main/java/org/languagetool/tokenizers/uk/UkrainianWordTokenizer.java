...
//  private static final char DECIMAL_SPACE_SUBST = '\uE008';
  ...
  private static final Pattern ABBR_DOT_PATTERN = Pattern.compile("([а-�?іїєґ])\\. ([а-�?іїєґ])");
  private static final Pattern ABBR_DOT_PATTERN2 = Pattern.compile("([�?а]кад|[Пп]роф|[Дд]оц|[�?а]�?и�?т|�?|м|вул|о|р|ім)\\.\\s([�?-ЯІЇЄ�?])");
