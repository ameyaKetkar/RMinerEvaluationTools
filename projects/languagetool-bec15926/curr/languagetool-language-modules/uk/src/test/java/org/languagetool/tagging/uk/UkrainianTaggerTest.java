...
public class UkrainianTaggerTest extends TestCase {
  ...
  public void testTaggingWithDots() throws IOException {
    ...
    TestTools.myAssert("300 ти�?. гривень", 
        "300/[300]number -- ти�?./[ти�?.]numr:f:v_dav:nv:abbr|ти�?./[ти�?.]numr:f:v_mis:nv:abbr|ти�?./[ти�?.]numr:f:v_naz:nv:abbr|ти�?./[ти�?.]numr:f:v_oru:nv:abbr|ти�?./[ти�?.]numr:f:v_rod:nv:abbr|ти�?./[ти�?.]numr:f:v_zna:nv:abbr -- гривень/[гривн�?]noun:p:v_rod",
         tokenizer, tagger);
