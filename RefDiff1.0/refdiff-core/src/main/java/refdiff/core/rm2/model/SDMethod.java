...
public class SDMethod extends SDEntity {
	...
	public void addParameter(String name, String type, String completeTypeName) {
        this.parameters.add(new Parameter(name, type, completeTypeName));
    }
	...
	public static class Parameter {
	    ...
	    public Parameter(String name, String type, String completeTypeName) {
            super();
            this.name = name;
            this.type = type;
