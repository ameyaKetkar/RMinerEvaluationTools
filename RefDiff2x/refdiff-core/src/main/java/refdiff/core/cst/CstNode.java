...
public class CstNode implements HasChildrenNodes {
	...
	private String oracleStyleName;
	...
	public String getOracleStyleName() {
		return oracleStyleName;
	}

	public void setOracleStyleName(String oracleStyleName) {
		this.oracleStyleName = oracleStyleName;
	}
