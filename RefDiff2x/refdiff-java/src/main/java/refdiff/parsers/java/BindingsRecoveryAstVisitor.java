...
public class BindingsRecoveryAstVisitor extends ASTVisitor {
	...
	public boolean visit(MethodDeclaration methodDeclaration) {
		...
		String methodSignOracleStyle = AstUtils.getOracleStyleSignatureFromMethodDeclaration(methodDeclaration);
		// if
...
//
//
//		HasChildrenNodes container = containerStack.peek();
//		String containerName = "";
//		if(container instanceof CstNode){
//			CstNode cntr = (CstNode) container;
//			containerName = cntr.getNamespace() + cntr.getSimpleName();
//		}

		final CstNode method = model.createMethod(methodSignature, containerStack.peek(), sourceFilePath, fileContent, methodDeclaration.isConstructor(), methodDeclaration, methodSignOracleStyle);
