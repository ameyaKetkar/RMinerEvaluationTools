...
public enum RefactoringType {
	...
	MOVE_RENAME_OPERATION("Move And Rename Method", "Move And Rename Method (.+) from class (.+) to (.+) from class (.+)"),
	...
	public static RefactoringType extractFromDescription(String refactoringDescription) {
		...
		//System.out.println("Cannot reason about " + refactoringDescription);
		return null;
