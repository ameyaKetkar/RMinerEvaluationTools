...
//				MeasuredResponse<List> measuredResponse = measureTime(() -> runRMiner(sources, folders));
...
//	}
//
//	private List runRMiner(PairBeforeAfter<SourceFolder> sources, PairBeforeAfter<Set<String>> folders) {
