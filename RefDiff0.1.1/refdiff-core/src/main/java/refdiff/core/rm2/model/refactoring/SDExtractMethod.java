...
//    }
    @Override
    public String toString() {
        if(origin.getContainerName().equals(extractedMethod.getContainerName())) {
            StringBuilder sb = new StringBuilder();
            sb.append(this.getName());
            sb.append(' ');
            sb.append(this.extractedMethod.getVerboseSimpleName());
            ...
            StringBuilder sb = new StringBuilder();
            sb.append("Extract And Move Method");
            sb.append(' ');
            sb.append(this.extractedMethod.getVerboseSimpleName());
            sb.append(" extracted from ");
            sb.append(origin.getVerboseSimpleName());
            ...
            sb.append(extractedMethod.getContainerName());
            return sb.toString();
        }
    }

    public String getAsExtractMethodString() {
        StringBuilder sb = new StringBuilder();
        sb.append(this.getName());
        sb.append(' ');
        sb.append(this.extractedMethod.getVerboseSimpleName());
        ...
        sb.append(origin.getVerboseSimpleName());
        sb.append(" in class ");
        sb.append(extractedMethod.container().fullName());
        return sb.toString();
    }
}
