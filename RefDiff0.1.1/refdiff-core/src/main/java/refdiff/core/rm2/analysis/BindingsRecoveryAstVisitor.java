...
//        postProcessReferences.put(type, references);
    ...
    public boolean visit(FieldDeclaration fieldDeclaration) {
        ...
        for (VariableDeclarationFragment fragment : fragments) {
            ...
            attribute.setCompleteType(AstUtils.normalizeTypeNameDontStrip(fieldType, fragment.getExtraDimensions(), false));
    ...
    public static void extractParametersAndReturnType(MethodDeclaration methodDeclaration, SDMethod method) {
        ...
        if (returnType != null) {
            ...
            method.setCompleteReturnType(AstUtils.normalizeTypeNameDontStrip(returnType, methodDeclaration.getExtraDimensions(), false));
        } else {
            method.setReturnType(null);
            method.setCompleteReturnType(null);
        }
        ...
        while (parameters.hasNext()) {
            ...
            String completeTypeName = AstUtils.normalizeTypeNameDontStrip(parameterType, parameter.getExtraDimensions(), parameter.isVarargs());
            method.addParameter(parameter.getName().getIdentifier(), typeName, completeTypeName);
        }
    }
