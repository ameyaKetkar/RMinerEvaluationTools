...
public class SDMethod extends SDEntity {
	...
	private String completeReturnType;
	...
	public SDMethod(SDModel.Snapshot snapshot, int id, String signature, SDContainerEntity container, boolean constructor) {
		...
		this.containerName = container.fullName();
	}
	...
	public void addParameter(String name, String type, String completeType) {
        this.parameters.add(new Parameter(name, type, completeType));
    }
	...
	public String getCompleteReturnType() {
		return completeReturnType;
	}

	public void setCompleteReturnType(String completeReturnType) {
		this.completeReturnType = completeReturnType;
	}

	public static class Parameter {
	    private final String name;
	    private final String type;
	    private final String completeTypeName;
        
	    public Parameter(String name, String type, String completeType) {
            super();
            this.name = name;
            this.type = type;
            this.completeTypeName = completeType;
        }
	...
	public String getVerboseSimpleName() {
        ...
        for (int i = 0; i < parameters.size(); i++) {
            ...
            sb.append(' ');
            sb.append(param.getCompleteTypeName());
        }
        sb.append(')');
        if (!isConstructor()) {
            sb.append(" : ");
            sb.append(completeReturnType);
        }
        return sb.toString();
    }
